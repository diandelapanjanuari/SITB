...
class Berita extends Model
{
	...
	public function ambilLaporanSpesifik($id)
	{
		try {
			$stmt = $this->db->prepare("SELECT * FROM laporan WHERE id_laporan=:id");
	...
	public function ubahBerita($id_laporan,$judul,$isi,$kategori)
	{
